...
export const contentApi = {
  ...
  createCategory: async (dto: { name: string }) =>
    axiosClient.post('/api/ArticleCategories', dto),

  updateCategory: async (id: number, dto: { name: string }) =>
  ...
  createArticle: async (dto: { title: string; content: string; categoryId: number }) =>
    axiosClient.post('/api/Articles', dto) as Promise<{ id: number; title: string; slug: string }>,

  updateArticle: async (id: number, dto: { title: string; content: string; categoryId: number }) =>
