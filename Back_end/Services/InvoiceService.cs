    ...
    public class InvoiceService : IInvoiceService
    {
        ...
        public async Task<InvoiceResponseDto> CreateInvoiceAsync(int bookingId)
        {
            ...
            var invoice = new Invoice
            {
                ...
                TaxAmount = Math.Max(0m, (totalRoom + deliveredServiceTotal - discount)) * 0.1m, // VAT 10%
                FinalTotal = Math.Max(0m, (totalRoom + deliveredServiceTotal - discount)) + (Math.Max(0m, (totalRoom + deliveredServiceTotal - discount)) * 0.1m),
